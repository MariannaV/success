...
const validations = {
  ...
  minLength: kolichestvo => value =>
    value && value.length < kolichestvo && `Минимальная длина: ${kolichestvo} символов`,
  maxLength: kolichestvo => value =>
    value && value.length > kolichestvo && `Максимальная длина: ${kolichestvo} символов`,
...
document.querySelector('.login-form').addEventListener('submit', event => {
  ...
  ;[
    ...
    {
      fieldName: 'password',
      checks: [validations.required(), validations.minLength(10), validations.maxLength(100)],
    },
